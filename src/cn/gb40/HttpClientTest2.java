...
public class HttpClientTest2 {
	...
	private static   CloseableHttpClient httpClient = HttpClients.custom().setDefaultRequestConfig(requestConfig)
			.build();
	private static final String SESSIONID="JSESSIONID=748A26F8241CEB732078836E5D11C3EC;";
   //导出目录以及操作目录
	private    static  File autobg= new File(root+"autobg.json");
	private    static  File resultTxt=new File(root+"result.txt");
	private static final File codeJPG=new	 File("C:\\Users\\Administrator\\Desktop\\testOcr\\temp3\\", "code.jpg");
	private static final String codeSource="C:\\Users\\Administrator\\Desktop\\testOcr\\temp3\\code.jpg";
...
//					}
				...
				System.out.println("没有数据，或者出现异常！");
			}
