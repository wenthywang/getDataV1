...
public class DateUtil extends JPanel {
	...
	private DateUtil(Date date, String format) {
		initDate = date;
...
//		DateUtil dateChooser1 = DateUtil.getInstance("yyyy-MM-dd");
