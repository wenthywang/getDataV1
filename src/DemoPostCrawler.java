...
//        crawler.addSeed(new CrawlDatum("http://xmiles.cn/xmiles-manager/system/login.action")
//                .putMetaData("method", "POST")
//                .putMetaData("outputData", "userId=1234")
//                .putMetaData("outputData", "password=3423"));
